...
def load_assets():
    ...
    assets[G_RETA] = pygame.image.load(os.path.join(IMG_DIR, "g_reta.png")).convert()
    ...
    assets[G_RETA_E] = pygame.image.load(os.path.join(IMG_DIR, "g_reta_e.png")).convert()
    ...
    assets[G_RETA_D] = pygame.image.load(os.path.join(IMG_DIR, "g_reta_d.png")).convert()
    ...
    assets[G_DOIS_VE] = pygame.image.load(os.path.join(IMG_DIR, "g_reta_d.png")).convert()
    ...
    assets[G_DOIS_VD] = pygame.image.load(os.path.join(IMG_DIR, "g_dois_vd.png")).convert()
    ...
    assets[G_DOIS_H] = pygame.image.load(os.path.join(IMG_DIR, "g_dois_h.png")).convert()
    ...
    assets[G_TRES] = pygame.image.load(os.path.join(IMG_DIR, "g_tres.png")).convert()
