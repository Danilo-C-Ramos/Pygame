...
def load_assets():
    ...
    assets[GRAMA] = pygame.image.load(os.path.join(IMG_DIR, "Gramabkgrnd.png"))
    assets[ARVORE] = pygame.image.load(os.path.join(IMG_DIR, "Arvore.png"))
    assets[BUEIRO] = pygame.image.load(os.path.join(IMG_DIR, "Bueiro.png"))
    assets[CACHORRO] = pygame.image.load(os.path.join(IMG_DIR, "Cachorro.png"))
